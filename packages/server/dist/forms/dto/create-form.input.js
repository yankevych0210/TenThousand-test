...
__decorate([
    (0, graphql_1.Field)(() => [question_input_1.QuestionInput], { nullable: true }),
    __metadata("design:type", Object)
], CreateFormInput.prototype, "questions", void 0);
exports.CreateFormInput = CreateFormInput = __decorate([
    (0, graphql_1.InputType)({ description: "Input for creating a new form" })
], CreateFormInput);
